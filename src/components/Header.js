...
class Header extends Component {
    componentDidMount() {
        window.onscroll = () => {
            ...
            if(homeSection.y <= 200 && homeSection.y > -homeSection.height + 200) homeMenuItem.className ="nav-link activated";
            else homeMenuItem.className = "nav-link";
            ...
            if(aboutSection.y <= 200 && aboutSection.y > -aboutSection.height + 200) aboutMenuItem.className ="nav-link activated";
            else aboutMenuItem.className = "nav-link";
            ...
            if(skillsSection.y <= 200 && skillsSection.y > -skillsSection.height + 200) skillsMenuItem.className ="nav-link activated";
            else skillsMenuItem.className = "nav-link";
            ...
            if(projectsSection.y <= 200 && projectsSection.y > -projectsSection.height + 200) projectsMenuItem.className ="nav-link activated";
            else projectsMenuItem.className = "nav-link";
            ...
            if(experienceSection.y <= 200 && experienceSection.y > -experienceSection.height + 200) experienceMenuItem.className ="nav-link activated";
            else experienceMenuItem.className = "nav-link";
            ...
            if(contactSection.y <= 200) contactMenuItem.className ="nav-link activated";
            else contactMenuItem.className = "nav-link";
        };
    }
